// lib/features/account/presentation/pages/verify_email_change_page.dart
...
class VerifyEmailChangePage extends StatefulWidget {
  final String userId;
  final String email;
  ...
  @override
  State<VerifyEmailChangePage> createState() => _VerifyEmailChangePageState();
}

class _VerifyEmailChangePageState extends State<VerifyEmailChangePage> {
  ...
  void _handleVerify() {
    if (_formKey.currentState!.validate()) {
      context.read<ProfileUpdateCubit>().verifyEmailUpdate(
